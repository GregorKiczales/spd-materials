...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname tuition-graph-c-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
(require spd/tags)
