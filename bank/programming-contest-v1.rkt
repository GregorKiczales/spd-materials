...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname programming-contest-v1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
...
(define P2 (make-problem "Graphs"           6 12))
...
(define P8 (make-problem "Searching"       25 45))
