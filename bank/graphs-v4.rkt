...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname graphs-gen-v4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(require spd/tags)
