...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname max-exits-from-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
