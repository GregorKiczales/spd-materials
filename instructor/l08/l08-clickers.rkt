...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname l08-clickers) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
(require 2htdp/image)
...
Given the following type comments and one template function:
|#
...
The colors show the arrow correspondence:
...
;; QUESTION [30 seconds]
;;
;; I spent this many hours so far preparing for the midterm:
;; 
;; A. more than 15
;; B. 10 to 15
;; C.  7 to 10
