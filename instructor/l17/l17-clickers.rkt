...
;; A. (@template encapsulated Pos (listof Pos))
;; B. (@template encapsulated Pos (listof Pos) try-catch)
;; C. (@template encapsulated genrec Pos (listof Pos) try-catch)
;; D. (@template encapsulated genrec arb-tree try-catch)
;; E. (@template encapsulated genrec arb-tree Pos try-catch)
