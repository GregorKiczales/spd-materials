...
;;
;; PROBLEM: Decorate a picture of the tree with the value of the
;;          path accumulator argument at each call to fn-for-t
;;          and fn-for-lot.
;;          Then write the accumulator type and invariant.  Be
...
;;
;; PROBLEM: Decorate a picture of the tree with the value of the
;;          t-wl, visited and rsf accumulator arguments at each call
;;          to fn-for-t and fn-for-lot.
;;          Then write the accumulator type and invariant.  Be
;;          as precise as possible.
;;
(define (bar t0)
