...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname m11-maze-4-way-path-length-tr-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
...
(@problem 1)
;;
;; Convert this function to produce the length of the first
;; path if possible. False otherwise. Your function must
;; be tail recursive.
;;
